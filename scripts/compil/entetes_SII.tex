...
\def\xxnumchapitre{Devoir surveillé de SII 2\vspace{.2cm}}
...
\def\xxsourceexo{\hspace{.2cm} X -- ENS -- PSI 2016}


\def\xxfigures{\includegraphics[width=.5\linewidth]{fig_00}}
\def\xxpied{%
\textsf{DS 2}%dans le but de déterminer les contraintes géométriques dans les mécanismes\\% afin de valider leurs performances.\\
